...
# Cicle = True
# while Cicle:            # Запрос сложности бота
#     complexity = input('Выберите сложность бота: 1 - БОГ 2 - БАЛБЕС  Ваш выбор-')
#     if complexity == '1' or complexity == '2':
#         Cicle = False         
#     else:
#         print('Введите число равное 1 или 2 , где  1 - БОГ 2 - БАЛБЕС (уровень бота)') 
#         print()    
# print()
complexity = 1
