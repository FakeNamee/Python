...
with open('file1.txt') as f:
    str2 = f.readline()
print('Из файла file0.txt получена следующая строка с уравнением: ', end='')
print(str1)
print('Из файла file1.txt получена следующая строка с уравнением: ', end='')
print(str2)
...
print(New_STRING)
print('И записаны в файл : fileNEW.txt')
